...
import 'package:social_app_tutorial/modules/post/models/message_data.dart';
                            ...
                            child: Column(
                              children: [
                                AdvancedAvatar(
                                  ...
                                  child: Image(
                                    image: NetworkImage(
                                        results[index].user!.picture!.thumbnail.toString()),
                                  ),
                                ),
                                Padding(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ListTile(
                          leading: AdvancedAvatar(
                            ...
                            child: Image(
                              image:
                                  NetworkImage(results[index].user!.picture!.thumbnail.toString()),
                            ),
                          ),
                          title: Text(
                            userName,
